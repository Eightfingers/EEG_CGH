...
#Unpack Mocap Data Functions
    ...
    def __unpack_labeled_marker_data( self, data, packet_size, major, minor):
        ...
        if( ( major == 2 and minor > 3 ) or major > 2 ):
            ...
            for _ in range( 0, labeled_marker_count ):
                ...
                if (model_id== 0):
                    marker_modelID_0_positions.append(pos)
        ...
        return offset, labeled_marker_data, marker_modelID_0_positions
    ...
    def __unpack_mocap_data( self, data : bytes, packet_size, major, minor):
        ...
        # Labeled Marker Data
        rel_offset, labeled_marker_data, marker_modelID_0_positions = self.__unpack_labeled_marker_data(data[offset:], (packet_size - offset),major, minor)
        offset += rel_offset
        ...
        if self.new_frame_listener is not None:
            ...
            data_dict[ "marker_modelID_0_positions"] = marker_modelID_0_positions
