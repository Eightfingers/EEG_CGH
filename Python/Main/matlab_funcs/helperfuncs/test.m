function test(x, y)
% TEST Reconstruct figure in SPLINETOOL.
%
%   TEST(x, y) creates a plot, similar to the plot in SPLINETOOL, using the
%   data that you provide as input.
...
knots = augknt(knots,3);
% You changed the order:
knots = augknt(knots,4);
% Least-squares approximation.
spline1 = spap2(knots,4,x,y); 
