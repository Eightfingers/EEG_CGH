...
circumference = readmatrix('charlie_circum_003.csv');
ear2ear = readmatrix('charlie_ear2ear_004.csv');
nziz = readmatrix ('charlie_nziz_002.csv');
...
static = readmatrix('charlie_static.csv');
...
Fpz_static = static_markers(17,:);
Fp2_static = static_markers(16,:);
F8_static = static_markers(4,:);
T4_static = static_markers(8,:);
T6_static = static_markers(12,:);
O2_static = static_markers(9,:);
Oz_static = static_markers(13,:);
O1_static = static_markers(21,:);
T5_static = static_markers(15,:);
T3_static = static_markers(20,:);
F7_static = static_markers(19,:);
Fp1_static = static_markers(18,:);
Cz_static = static_markers(6,:);
Pz_static = static_markers(10,:);
C4_static = static_markers(6,:);
C3_static = static_markers(3,:);
FZ_static = static_markers(2,:)
F4_static = static_markers(7,:);
F3_static = static_markers(7,:);
P3_static = static_markers(11,:);
P4_static = static_markers(14,:);
