...
addpath('10_1_2022\transformation done in matlab');
...
plot3(stylus_data(:,1), stylus_data(:,2), stylus_data(:,3), 'd');
...
plot3(new_markers_circum(:,1), new_markers_circum(:,2), new_markers_circum(:,3), 'kd');
hold on;
plot3(final_points(:,1), final_points(:,2), final_points(:,3), 'kd', 'markersize', 20);
plot3(four_points(:,1), four_points(:,2), four_points(:,3), 'rd', 'markersize', 20);
...
%% The shift
load('21points_result_from_optitrack')
plot3(predicted(:,1), predicted(:,2), predicted(:,3), 'rd', 'markersize', 20); 

load('optitrack_circum_dataset')
plot3(circumference_dataset(:,1), circumference_dataset(:,2), circumference_dataset(:,3), 'rd'); 
load('optitrack_e2e_dataset')
plot3(e2e_dataset(:,1), e2e_dataset(:,2), e2e_dataset(:,3), 'rd'); 
load('optitrack_nziz_dataset')
plot3(nziz_dataset(:,1), nziz_dataset(:,2), nziz_dataset(:,3), 'rd'); 

load('optitrack_3traces');
plot3(nziz_trace(:,1), nziz_trace(:,2), nziz_trace(:,3), 'd');
plot3(circumference_trace(:,1), circumference_trace(:,2), circumference_trace(:,3), 'd');
plot3(ear2ear_trace(:,1), ear2ear_trace(:,2), ear2ear_trace(:,3), 'd');
