...
stylus_data = readmatrix('data_CIRCUMstylus_specs_frame');
...
%%% Ear to Ear
stylus_data = readmatrix('data_EarToEarstylus_specs_frame');
stylus_data = [stylus_data(:,1) stylus_data(:,3) stylus_data(:,2)]; 
stylus_data = rmmissing(stylus_data);
...
plot3(circumference_dataset(:,1), circumference_dataset(:,2), circumference_dataset(:,3), 'kd');
